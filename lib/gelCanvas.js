// - ----------------------------------------------------------------------------------------- - //
/*!
 *  gelCanvas.js v0.1.0 - Canvas2D Graphics Playground
...
// - ----------------------------------------------------------------------------------------- - //
function gelOnPauseDraw( _func ) {
	GelInternal.OnPauseDraw = _func;
}
// - ----------------------------------------------------------------------------------------- - //
function gelHasFocus() {
	return window.hasFrameFocus;
}
// - ----------------------------------------------------------------------------------------- - //
function gelCanvasSmoothing( canvas, value ) {
...
// - ----------------------------------------------------------------------------------------- - //
function gelSimpleSetup( _title ) {
...
// - ----------------------------------------------------------------------------------------- - //
function gelCanvasClear( ctx, _color ) {
	ctx.save();
...
// - ----------------------------------------------------------------------------------------- - //
function gelCanvasIdentity( ctx ) {
...
if (typeof window !== "undefined") {
	window.gelCanvasCreate = gelCanvasCreate;
	window.gelCanvasSmoothing = gelCanvasSmoothing;
	window.gelHasFocus = gelHasFocus;
	window.gelOnPauseDraw = gelOnPauseDraw;

	window.RGB = function(r,g,b){ return "rgb("+r+","+g+","+b+")"; };
	window.RGBA = function(r,g,b,a){ return "rgba("+r+","+g+"b"+b+","+(a/255.0)+")"; };

	window.gelCanvasClear = gelCanvasClear;
	window.gelCanvasIdentity = gelCanvasIdentity;
	
	window.gelSimpleSetup = gelSimpleSetup;
	window.gelSimpleStart = gelSimpleStart;
}
// - ----------------------------------------------------------------------------------------- - //
})();
// - ----------------------------------------------------------------------------------------- - //
