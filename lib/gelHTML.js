...
if ( !global.hasCanvas ) {
	return document.write("ERROR! Requires canvas support!");
}
// - ----------------------------------------------------------------------------------------- - //
...
if ( !global.hasBlob ) {
	return document.write("ERROR! Requires Blob support!");
}
...
//if ( !global.hasBlob ) {
//	return document.write("ERROR! Requires Blob+URL support!");
//}
// - ----------------------------------------------------------------------------------------- - //
// Optional Features //
// - ----------------------------------------------------------------------------------------- - //
